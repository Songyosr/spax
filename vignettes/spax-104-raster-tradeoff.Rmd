...
The operation above processes hundreds of thousands of cells in a single step, leveraging optimized matrix operations under the hood. Essentially, as long as you can represent your problem in a vectorized format, it can be applied to a raster
